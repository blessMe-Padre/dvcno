        ...
        <div className={`${styles.bg} container relative`}>
          ...
          <div className={styles.wrapper}>
            <div className={styles.wrapper_title}>
              <h2 className={`${styles.title} ${styles.color_white}`}>
                Миссия ДВЦНО{" "}
              </h2>
              <Image
                src={decor}
            ...
            <div className={styles.info}>
              <div className={styles.info_content}>
                <p className={styles.text}>
                  <span style={{ fontWeight: "700" }}> МИССИЯ ДВЦНО </span>-
                  удовлетворение образовательных потребностей и запросов
                  государства и социума в получении доступного и качественного
                  образования детей, взрослых и талантливой молодежи,
                  соответствующего требованиям инновационного социально
                  ориентированного развития Приморского края.
                </p>

                <p className={styles.text}>
                  <span style={{ fontWeight: "700" }}>
                    {" "}
                    Инновационное оказание услуг
                  </span>{" "}
                  в области образования от дошкольного до профессионального,
                  разностороннее развитие личностей, их адаптации к жизни в
                  обществе, стимулирование к познанию и творчеству, подготовка
                  высокообразованных, конкурентоспособных, ориентированных на
                  саморазвитие и непрерывное профессиональное образование
                  специалистов
                </p>
              </div>
