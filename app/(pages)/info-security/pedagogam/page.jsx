...
const documentData2 = [
    ...
    {
        title: "Методические комплексы для психологического сопровождения обучающихся общеобразовательных организаций, в том числе программы развития социально эмоциональных навыков учащихся",
        link: "/",
    },
    {
        title: "Профилактика интернет-рисков: методические рекомендации для педагогов и родителейПсихологическая безопасность детей и подростков в образовательной среде:рекомендации для руководителей, педагогов, психологов образовательных организацийИнформационно-методические материалы по профилактике криминализации образовательной сред",
        link: "/",
    },
    {
        title: "Применение медиативных и восстановительных технологий в сфере предупреждения деструктивных проявлений среди несовершеннолетнихРабота с родителями обучающихся образовательных организаций по проведению профилактической деятельности с несовершеннолетними, склонными к суицидальному поведению. Методические рекомендации для педагогов-психологов и социальных педагогов образовательных организацийДополнительная общеразвивающая программа интерактивных занятий для детей, подростков и молодежи по вопросам ненасильственных методов разрешения споров и конфликтов «Курс юного переговорщика»",
        link: "/",
    },
];
const documentData = [
