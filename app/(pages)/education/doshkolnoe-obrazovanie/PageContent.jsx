...
export default function Page({ data }) {
    ...
    const link2 = {
        ru: 'Дошкольное образование в ДВЦНО',
        en: 'Preschool education in DVTSNO',
        ch: '学前教育在DVTSNO'
    };
    const learn_more = {
        ru: 'Узнать подробнее',
                ...
                <section className={`${styles.section} section-dsv`}>
                    <div className='container'>
                        <div className={styles.row}>
                            <div>
                                <h2 className={`${styles.title} ${styles.text_white}`}>{desc[0].title} <span className={`${styles.sticker} ${styles.text_white}`}>{desc[0].subtitle}</span></h2>
                        ...
                        <div className={styles.row}>
                            ...
                            <div>
                                <h2 className={`${styles.title} ${styles.text_white}`}>{desc[1].title} <span className={`${styles.sticker} ${styles.text_white}`}>{desc[1].subtitle}</span></h2>
