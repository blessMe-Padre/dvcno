...
export default function page() {
  ...
  const data_acts = [
    ...
    {
      title:
        "Порядок возникновения, приостановления и прекращения отношений между АНПОО «ДВЦНО» и обучающимися и (или) родителями (законными представителями) несовершеннолетних обучающихся подпись",
      link: "/",
    },
    ...
    {
      title:
        "Положение об организации и осуществлении образ. деятельности по ДОП АНПОО ДВЦНО_ЭЦП",
      link: "/",
    },
    ...
    {
      title:
        "Положение о внутр системе оценки качества образования в СП АНПОО ДВЦНО_ЭЦП",
      link: "/",
    },
    ...
    {
      title:
        "Порядок обучения по инд учебному плану в том числе при ускор обучении_ЭЦП",
      link: "/",
    },

    {
      title:
        "Положение о формах периодичности и порядке текущего контроля успеваемости и промежут аттестации обучающихся по осн общеобр прогр_ЭЦП",
      link: "/",
    },
    ...
    {
      title:
        "Порядок возникновения, приостановления и прекращения отношений между АНПОО «ДВЦНО» и обучающимися и (или) родителями (законными представителями) несовершеннолетних обучающихся",
      link: "/",
    },

    {
      title:
        "Правила приема на обучение в структурные подразделения АНПОО ДВЦНО",
      link: "/",
    },
    ...
    {
      title:
        "Положения об ограничении доступа обучающихся к информации подпись",
      link: "/",
    },
    ...
    {
      title:
        "Положение об официальном сайте и об информациооной открытости АНПОО ДВЦНО",
      link: "/",
    },
    ...
    {
      title:
        "Положение о нормах профессиональной этике педагогических работников",
      link: "/",
    },
    ...
    {
      title:
        "Режим занятий обучающихся в структурных подразделениях АНПОО ДВЦНО",
      link: "/",
    },
  ...
  return (
    <>
      <section>
        <div className="container">
          ...
          <div className={styles.title_wrapper}>
            ...
            <Image src={decor1} width={100} height={100} alt="" />
          </div>
      ...
      <section className={styles.section}>
        <div className="container">
          <div className={styles.title_wrapper}>
            ...
            <Image src={decor2} width={100} height={100} alt="" />
          </div>
      ...
      <section className={`${styles.section} ${styles.section_custom}`}>
        <div className="container">
          <div className={styles.title_wrapper}>
            ...
            <Image src={decor4} width={100} height={100} alt="" />
            <Image src={decor3} width={100} height={100} alt="" />
          </div>
      ...
      <section
        className={`${styles.section} ${styles.bg_gray} ${styles.section_custom}`}
      >
        <div className="container">
          <div className={styles.title_wrapper}>
            <h2 className={styles.title}>
      ...
      <section className={styles.section}>
        <div className="container">
          <div className={styles.title_wrapper}>
            <h2 className={styles.title}>Графики оценочных процедур</h2>

            <Image src={decor5} width={100} height={100} alt="" />
          </div>
