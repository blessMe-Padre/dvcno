            ...
            <section className={`${styles.section} section-dsv`}>
                <div className='container'>
                    <div className={styles.row}>
                        <div>
                            <h2 className={`${styles.title} ${styles.text_white}`}>Дошкольные группы <span className={`${styles.sticker} ${styles.text_white}`}>3-7 лет</span></h2>
                    ...
                    <div className={styles.row}>
                        ...
                        <div>
                            <h2 className={`${styles.title} ${styles.text_white}`}>Подготовительный класс <span className={styles.sticker}>6-7 лет</span></h2>
