...
const AnimateItems = ({ data }) => {
  return (
    <ul className={styles.list_wrapper}>
      {data.map((item, index) => (
        <ul
          className={`${styles.ul_wrapper} ${
            index % 2 ? `${styles.ul_wrapper_reversed}` : ""
          }`}
          key={index}
        >
          {index != data.length - 1 ? (
            <>
              ...
              <li
                className={`${styles.list_content} ${
                  item.year ? "" : `${styles.custom_list_content}`
                }`}
              >
                <div className={styles.list_content_wrapper}>
                  ...
                  >
                    {item.year && (
                      <div
                        className={`${styles.list_content_year} ${
                          item.className === "light-blue"
                      ...
                      >
                        <div
                          className={`${styles.circle_last_small} ${
                            item.className === "light-blue"
                              ? styles.light_blue_border
                              : item.className === "green"
                              ? styles.green_border
                    ...
                    {item.year ? (
                      <svg
                        className={styles.history_decor}
                        width="63"
                        height="65"
                        viewBox="0 0 63 65"
                        fill="none"
                      ...
                      <svg
                        className={styles.history_decor_without_year}
                        width="63"
                        height="65"
                        viewBox="0 0 63 65"
                        fill="none"
