                ...
                {data.map((item, index) => (
                    ...
                    >
                        <div className={`${styles.contact_name_wrapper}                                                 
                            ...
                            <SVG_BG_Compoment color={item.background} />
                        ...
                        <ul className={styles.contact_info}>
                            <li className={styles.info_item}>
                                <div className={styles.info_item_url}>
                                    <div className={styles.wrapper_svg}>
                                        <svg
                                            className={`${item.background === 'yellow' ? styles.fill_yellow : ''}
                                                        ${item.background === 'light-blue' ? styles.fill_light_blue : ''}
                                                        ${item.background === 'purple' ? styles.fill_purple : ''}
                                                        ${item.background === 'green' ? styles.fill_green : ''}
                                                        ${item.background === 'violet' ? styles.fill_violet : ''}
                                                    `}
                                    ...
                                    <div>
                                        ...
                                        <p style={{ fontWeight: '600'}}>{item.url}</p>
                                    </div>
                                </div>                                            
                            ...
                            <li className={styles.info_item}>
                                <div className={styles.info_item_works}>
                                    ...
                                    <div>
                                        ...
                                        <p style={{ fontWeight: '600'}} dangerouslySetInnerHTML={{ __html: item.works_of_clock}}></p>
                                    </div>
                                </div>                                    
                            </li>
                            ...
                            <li className={styles.info_item}>
                                <div className={styles.info_item_phone}>
                                    ...
                                    <div>
                                        ...
                                        <a style={{ fontWeight: '600'}} href={item.phone_bot}><p>{item.phone}</p></a>
                                        <a style={{ fontWeight: '600'}} href={item.phone_bot2}><p>{item.phone2}</p></a>
                                    </div>
                                </div>                             
                            </li>
                            ...
                            <li className={styles.info_item}>
                                    ...
                                    <div>
                                        ...
                                        <Link style={{ fontWeight: '600'}} href={'item.mail'}><p>{item.mail}</p></Link>
                                        <Link style={{ fontWeight: '600'}} href={'item.mail2'}><p>{item.mail2}</p></Link>
                                    </div>
                                </div>                          
                            </li>
